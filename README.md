...
- **DDP + AMP** 기반 학습 지원
- 선택적으로 **EFFORT style SVD-Residual** (저랭크 잔차 업데이트)를 SwinV2 **마지막 stage**에 적용하여 **파라미터 효율적 미세튜닝**을 수행합니다.

## Results (Leaderboard)
- 🏆 **상위 6.7% (31 / 458)**

<img width="1195" height="53" alt="리더보드 캡쳐" src="https://github.com/user-attachments/assets/cebbb5c1-da72-4fbf-9285-0da7926b0c9d" />
