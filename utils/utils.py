...
def read_rgb_frames(file_path, num_frames) -> List[np.ndarray]:
    ...
    if ext in VIDEO_EXTS:
        ...
        frame_indices = list(map(int, uniform_frame_indices(total, num_frames)))
        pick = set(frame_indices)
...
def reduce_tensor(tensor):
    # DDP 미사용(단일 프로세스/단일 GPU)면 그대로 반환
