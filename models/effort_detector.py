...
class EffortDetector(nn.Module):
    ...
    def build_backbone(self, config):
        ...
        clip_model = CLIPModel.from_pretrained(
            "../../huggingface/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41/")
...
class SVDResidualLinear(nn.Module):
    ...
    def compute_orthogonal_loss(self):
        ...
        # Frobenius norm
        loss = 0.5 * torch.norm(UUT_residual - UUT_residual_identity, p='fro') + 0.5 * torch.norm(
            VVT_residual - VVT_residual_identity, p='fro')
